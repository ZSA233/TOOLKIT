...
API_BLUEPRINT_VERSION ?= v1.2.0
API_BLUEPRINT_PACKAGE ?= git+https://github.com/ZSA233/api-blueprint@$(API_BLUEPRINT_VERSION)
API_BLUEPRINT_RUN ?= $(if $(strip $(API_BLUEPRINT_PROJECT)),$(UV) run --project '$(API_BLUEPRINT_PROJECT)',$(UV) tool run --from '$(API_BLUEPRINT_PACKAGE)')
